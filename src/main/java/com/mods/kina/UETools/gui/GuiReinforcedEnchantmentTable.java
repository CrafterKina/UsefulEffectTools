package com.mods.kina.UETools.gui;
...
public class GuiReinforcedEnchantmentTable  extends GuiContainer
{
    ...
    private ContainerReinforcedEnchantmentTable field_147075_G;
    ...
    public GuiReinforcedEnchantmentTable(InventoryPlayer p_i1090_1_, World p_i1090_2_, int p_i1090_3_, int p_i1090_4_, int p_i1090_5_)
    {
        super(new ContainerReinforcedEnchantmentTable(p_i1090_1_, p_i1090_2_, p_i1090_3_, p_i1090_4_, p_i1090_5_));
        this.field_147075_G = (ContainerReinforcedEnchantmentTable)this.inventorySlots;
    }
    ...
    {
        this.fontRendererObj.drawString(I18n.format("container.enchant"), 12, 5, 4210752);
    ...
    public void func_147068_g()
    {
        ...
        if (!ItemStack.areItemStacksEqual(itemstack, this.field_147077_B))
        {
            ...
            do
            {
                this.field_147082_x += (float)(this.rnd.nextInt(4) - this.rnd.nextInt(4));
            }
