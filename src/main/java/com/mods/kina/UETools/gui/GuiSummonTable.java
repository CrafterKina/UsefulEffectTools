...
public class GuiSummonTable extends GuiContainer{
    private static final ResourceLocation dispenserGuiTextures = new ResourceLocation("textures/gui/container/dispenser.png");
    public TileEntitySummonTable dropper;

    public GuiSummonTable(InventoryPlayer par1InventoryPlayer, TileEntitySummonTable par2TileEntityTDropper){
        super(new ContainerSummonTable(par1InventoryPlayer, par2TileEntityTDropper));
