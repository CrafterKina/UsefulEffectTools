...
import com.mods.kina.UETools.tileentity.InventoryDPhone;
...
public class ContainerDPhone extends Container{
    private IMerchant theMerchant;
    private InventoryMerchant merchantInventory;
    /** Instance of World. */
    private final World theWorld;

    public ContainerDPhone(InventoryPlayer p_i1821_1_, IMerchant p_i1821_2_, World p_i1821_3_)
    {
        this.theMerchant = p_i1821_2_;
        this.theWorld = p_i1821_3_;
        this.merchantInventory = new InventoryDPhone(p_i1821_1_.player, p_i1821_2_);
