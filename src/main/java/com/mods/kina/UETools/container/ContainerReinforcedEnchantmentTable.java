...
public class ContainerReinforcedEnchantmentTable extends Container
{
    /** SlotEnchantmentTable object with ItemStack to be enchanted */
    public IInventory tableInventory = new InventoryBasic("REnchant", true, 1)
    {
        /**
    ...
    public ContainerReinforcedEnchantmentTable(InventoryPlayer p_i1811_1_, World p_i1811_2_, int p_i1811_3_, int p_i1811_4_, int p_i1811_5_)
    {
